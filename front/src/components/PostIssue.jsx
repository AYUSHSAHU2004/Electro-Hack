...
const PostIssue = () => {
    ...
    const sampleData = [
        {
          id: 1,
          imageUrl: 'https://images.pexels.com/photos/25652584/pexels-photo-25652584/free-photo-of-elegant-man-wearing-navy-suit.jpeg?auto=compress&cs=tinysrgb&w=400',
  ...
  return (
    <div class="bg-gray-100">
        <div class="header my-3 h-12 px-10 flex items-center justify-between">
            <h1 class="font-medium text-2xl">Post an issue</h1>
        </div>
          ...
          <tbody>
            {sampleData.map((item, index) => (
              <tr key={index}>
                ...
                <td className="p-2"><img src={item.imageUrl} alt="Problem" className="h-8 w-8 mx-auto" /></td>
